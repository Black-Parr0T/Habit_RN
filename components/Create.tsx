        ...
        <ScrollView >
            <View style={styles.createCont}>
                <View style={styles.header}>
                    ...
                    <Text style={styles.text}>Create {pathname.slice(1)}</Text>
                    <TouchableOpacity>
                ...
                {
                    pathname.slice(1) === 'Dailies' ? <Scheduling /> : ''
                }
                {
                    pathname.slice(1) === 'Habit' ?
                        <View>
                ...
                {
                    pathname.slice(1) === 'Dailies' ? <Reminders /> : ''
                }
                <Reminders />
            </View>
        </ScrollView>
